...
TEST(geo, normal) {
    ASSERT_EQ(geo::normal(triangle_vec3{{glm::vec3(0, 0, 0),
                                        glm::vec3(0, 1, 0),
                                        glm::vec3(0, 0, 1)}}),
              glm::vec3(1, 0, 0));
    ...
    ASSERT_EQ(geo::normal(triangle_vec3{{glm::vec3(-1, 0, 1),
                                        glm::vec3(0, 1, 0),
                                        glm::vec3(1, 0, -1)}}),
