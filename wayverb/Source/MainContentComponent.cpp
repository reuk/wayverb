...
MainContentComponent::MainContentComponent(wayverb::combined::model::app& app)
        : left_bar_master_{app}
        , resizer_bar_{&layout_manager_, 1, true}
        , scene_master_{app}
        , components_to_position_{&left_bar_master_, &resizer_bar_, &scene_master_} {
    set_help("wayverb", "This is the main wayverb app window.");
    const auto left_bar_master_width = 300;
    layout_manager_.setItemLayout(
            0, left_bar_master_width, left_bar_master_width, left_bar_master_width);
