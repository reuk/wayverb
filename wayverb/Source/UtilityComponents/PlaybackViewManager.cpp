...
double PlaybackViewManager::get_max_length() const { return max_length; }
...
void PlaybackViewManager::addListener(Listener *l) { listener_list.add(l); }
...
void TransportViewManager::set_follow_playhead(bool b) { follow_playhead = b; }

bool TransportViewManager::get_follow_playhead() const {
    return follow_playhead;
}

void TransportViewManager::addListener(Listener *l) { listener_list.add(l); }
