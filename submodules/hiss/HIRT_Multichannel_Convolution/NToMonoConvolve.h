...
namespace HISSTools
{
    namespace DSP
    {
        ...
        public:
            ...
            void process(float **ins, float *out, float *temp1, uintptr_t numSamples, uint32_t active_in_chans);
            void process(float **ins, double *out, float *temp1, float *temp2, uintptr_t numSamples, uint32_t active_in_chans);
