...
namespace HISSTools
{
    namespace DSP
    {
        ...
        public:
            ...
            void process(float **ins, float *out, float *temp1, size_t numSamples, size_t active_in_chans);
            void process(float **ins, double *out, float *temp1, float *temp2, size_t numSamples, size_t active_in_chans);
