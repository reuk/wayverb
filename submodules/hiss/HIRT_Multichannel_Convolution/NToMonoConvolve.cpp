...
void HISSTools::DSP::NToMonoConvolve::process(float **ins, float *out, float *temp1, size_t numSamples, size_t active_inChans)
{
    // Zero output
...
void HISSTools::DSP::NToMonoConvolve::process(float **ins, double *out, float *temp1, float *temp2, size_t numSamples, size_t active_inChans)
{
	// Zero output temp
