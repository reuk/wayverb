...
TEST(triangle_square_intersection, perp) {
    ASSERT_EQ(core::geo::detail::perp(glm::vec2(0, 1)), glm::vec2(-1, 0));
    ASSERT_EQ(core::geo::detail::perp(glm::vec2(2, 2)), glm::vec2(-2, 2));
    ASSERT_EQ(core::geo::detail::perp(glm::vec2(-4, 2)), glm::vec2(-2, -4));
}

TEST(triangle_square_intersection, normal_2d) {
    ASSERT_EQ(core::geo::detail::normal_2d(glm::vec2(0, 0), glm::vec2(0, 1)),
              glm::vec2(-1, 0));
    ASSERT_EQ(core::geo::detail::normal_2d(glm::vec2(0, 0), glm::vec2(2, 2)),
              glm::vec2(-2, 2));
    ASSERT_EQ(core::geo::detail::normal_2d(glm::vec2(0, 0), glm::vec2(-4, 2)),
              glm::vec2(-2, -4));
}
...
TEST(triangle_square_intersection, normals_2d) {
    ...
    core::geo::detail::normals_2d(to_test.begin(), to_test.end(), out.begin());
    ASSERT_EQ(out,
...
TEST(triangle_square_intersection, project) {
    {
        ...
        ASSERT_EQ(core::geo::detail::project(
                          to_test.begin(), to_test.end(), glm::vec2(1, 0)),
                  (core::geo::detail::projection_2d{2, 2}));
        ASSERT_EQ(core::geo::detail::project(
                          to_test.begin(), to_test.end(), glm::vec2(-1, 0)),
                  (core::geo::detail::projection_2d{-2, -2}));
        ASSERT_EQ(core::geo::detail::project(
                          to_test.begin(), to_test.end(), glm::vec2(0, 1)),
                  (core::geo::detail::projection_2d{5, 5}));
        ASSERT_EQ(core::geo::detail::project(
                          to_test.begin(), to_test.end(), glm::vec2(0, -1)),
                  (core::geo::detail::projection_2d{-5, -5}));
    }

    {
        ...
        ASSERT_EQ(core::geo::detail::project(
                          to_test.begin(), to_test.end(), glm::vec2(1, 0)),
                  (core::geo::detail::projection_2d{-4, 2}));
        ASSERT_EQ(core::geo::detail::project(
                          to_test.begin(), to_test.end(), glm::vec2(-1, 0)),
                  (core::geo::detail::projection_2d{-2, 4}));
        ASSERT_EQ(core::geo::detail::project(
                          to_test.begin(), to_test.end(), glm::vec2(0, 1)),
                  (core::geo::detail::projection_2d{1, 5}));
        ASSERT_EQ(core::geo::detail::project(
                          to_test.begin(), to_test.end(), glm::vec2(0, -1)),
                  (core::geo::detail::projection_2d{-5, -1}));
    }
}
...
TEST(triangle_square_intersection, overlap) {
    ...
    ASSERT_TRUE(core::geo::detail::overlaps(
            a.begin(), a.end(), b.begin(), b.end(), glm::vec2(1, 0)));
    ASSERT_TRUE(core::geo::detail::overlaps(
            a.begin(), a.end(), b.begin(), b.end(), glm::vec2(-1, 0)));
    ASSERT_FALSE(core::geo::detail::overlaps(
