...
template <>
struct core::cl_representation<boundary_index_array_1> final {
...
template <>
struct core::cl_representation<boundary_index_array_2> final {
    static constexpr auto value = R"(
...
template <>
struct core::cl_representation<boundary_index_array_3> final {
    static constexpr auto value = R"(
