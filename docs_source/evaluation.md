...
contributions is lower for greater spacings, as expected.  The results of this
test are illustrated in +@fig:spacing_signals, which shows the impulse
responses generated by the two trials.
